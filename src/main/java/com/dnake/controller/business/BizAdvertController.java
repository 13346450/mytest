 ...
 */
@Controller
@RequestMapping("/business/BizAdvert/*")
@Login
public class BizAdvertController extends BaseController  {
	
	@Resource
	private BizAdvertService bizAdvertService;
	@Resource
	...
	@ResponseBody
	public Page<BizAdvertVO> listPage(@RequestParam("page") int pageIndex, int rows, SearchParam searchParam){
		return bizAdvertService.listPage(pageIndex ,rows, searchParam);
	}
	...
	public void insert(HttpServletResponse response, BizAdvert bizAdvert){
		outputString(response, bizAdvertService.insert(bizAdvert)); 
	}
	...
	public void update(HttpServletResponse response, BizAdvert bizAdvert){
		outputString(response, bizAdvertService.update(bizAdvert)); 
	}
	...
	public void delete(HttpServletResponse response, @PathVariable Long idKey){
		outputString(response, bizAdvertService.delete(response, idKey)); 
	}
	...
	public void auditAdvert(HttpServletResponse response, @PathVariable Long idKey){
		outputString(response, bizAdvertService.updateStatus(idKey, "audit")); 
	}
	...
	public void cancelAuditAdvert(HttpServletResponse response, @PathVariable Long idKey){
		outputString(response, bizAdvertService.updateStatus(idKey, "cancelAudit"));
	}
	...
	public void publishAdvert(HttpServletResponse response, @PathVariable Long idKey){
		outputString(response, bizAdvertService.updateStatus(idKey, "publish"));
	}
	...
	public void cancelPublishAdvert(HttpServletResponse response, @PathVariable Long idKey){
		outputString(response, bizAdvertService.updateStatus(idKey, "cancelPublish"));
	}
