...
public class BizPromotionGiftVO {
	//
	private Long idKey;
	// 促销活动id
	...
	public String toString() {
		return "BizPromotionGiftVO [idKey=" + idKey + ", promotionId="
				+ promotionId + ", total=" + total + ", startDt=" + startDt
				+ ", endDt=" + endDt + ", type=" + type + ", value=" + value
				+ ", goodsId=" + goodsId + ", couponCategory=" + couponCategory
				+ ", couponMinMoney=" + couponMinMoney + ", perMaxHave="
				+ perMaxHave + ", oneMaxUse=" + oneMaxUse + ", useWithOthers="
				+ useWithOthers + ", remarks=" + remarks + ", remain=" + remain
				+ ", name=" + name + ", minSum=" + minSum + ", shopName="
				+ shopName + ", shopId=" + shopId + "]";
	}
