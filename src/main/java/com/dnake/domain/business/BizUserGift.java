...
public String toString() {
	return "BizUserGift [idKey=" + idKey + ", userId=" + userId + ", shopId="
			+ shopId + ", giftId=" + giftId + ", status=" + status
			+ ", promotionId=" + promotionId + ", startDt=" + startDt
			+ ", endDt=" + endDt + ", chgDt=" + chgDt + ", type=" + type
			+ ", value=" + value + ", goodsId=" + goodsId + ", couponCategory="
			+ couponCategory + ", couponMinMoney=" + couponMinMoney
			+ ", oneMaxUse=" + oneMaxUse + ", useWithOther=" + useWithOthers
			+ ", remarks=" + remarks + "]";
}
