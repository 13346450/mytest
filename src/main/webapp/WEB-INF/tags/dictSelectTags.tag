...
<%@ attribute name="dictTypeId" type="java.lang.String" required="true" description="字典类别"%>
...
<input 
	...
	data-options="
					url:'${base}/system/SysDict/loadSelectTagData?dictTypeId=${dictTypeId}&t=<%= Math.random()%>',
					method:'get',
					valueField:'idKey',
					textField:'dictValue',
