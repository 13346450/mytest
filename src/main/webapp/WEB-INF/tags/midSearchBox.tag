...
<table>
	<tr>
		<td><label>监测点编号：</label></td><td class="tdLeft"><input name="stationNumber" class="TextBox" style="width: 150px" value="${stationNumber}"></td>
		...
		<td><label>安装地点：</label></td><td class="tdLeft"><input name="stationLocation" class="TextBox"></td>
	</tr>
</table>