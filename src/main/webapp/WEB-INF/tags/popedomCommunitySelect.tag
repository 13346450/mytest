...
<%@ attribute name="onSelect" type="java.lang.String" required="false" description="onSelect事件"%>
...
<input 
	...
	data-options="
					url:'${base}/system/SysCommunity/selectPopeDomCommunity?t=<%= Math.random()%>',
					method:'get',
					valueField:'idKey',
					...
					<c:if test="${onSelect ne null}">onSelect:${onSelect},</c:if>
