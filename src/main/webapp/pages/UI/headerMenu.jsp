...
<div class="col-xs-12 second">
	<div class="navbar-collapse collapse nav">
		<ul id="nav">
			...
			>首页</a></li>
			<li class="navpadding"><a href="${base}/">物业管理</a></li>
			<li class="navpadding"><a href="${base}/">社区商圈</a></li>
			<li class="navpadding"><a href="${base}/">智能控制</a></li>
			<li class="navpadding"><a href="${base}/">产品与解决方案</a></li>
			
			<li class="navpadding"><a href="${base}/system/SysNewsDynamic/" 
				<c:if test="${headerMenu=='news'}">class="active"</c:if>
			 >新闻动态</a></li>
			<li class="navpadding"><a href="${base}/system/SysAboutUS/" 
