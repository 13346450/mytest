...
<div class="container" style="margin-top:-40px; min-height:743px;">
  <div class="row">
     ...
     <div class="col-xs-10" style="margin:15px 0 0 15px; padding:0;">
      <div class="collect-top">商品收藏</div>
      <div class="store-name1"> <span class="left"><i id="cart-check" class="cart-ico cart-ico-input"></i>全选</span><span class="left marginl30">加入购物车</span><span class="left marginl30">取消收藏</span></div>
      <ul>
      <li class="left">
        <div class="history-listitem"> <img src="${base}/resources/images/ishangimg/search-pic18.png" width="158" height="135" style="margin:10px 5px;">
          <p class="marginall5">五芳斋 五香粽子礼盒2只装</p>
          <span class="red-word12 marginall5">&yen;89<i class="persaonal-ico personal09"></i></span> </div>
        <div style="margin:-7px 0 0 80px;"><i id="cart-check" class="cart-ico cart-ico-input" style="float:none;"></i></div>
      </li>
       <li class="left">
        <div class="history-listitem"> <img src="${base}/resources/images/ishangimg/search-pic18.png" width="158" height="135" style="margin:10px 5px;">
          <p class="marginall5">五芳斋 五香粽子礼盒2只装</p>
      ...
      <div class="clear"></div>
      <div style="width:700px; margin:50px 0 0 300px;">
  <div id="kkpager"></div>
</div>
    </div>
  </div>
