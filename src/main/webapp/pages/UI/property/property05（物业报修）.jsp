...
<div class="container" style="min-height:743px;">
  ...
  <div class="col-xs-10" style="margin:15px 0 0 15px; padding:0;">
     <div class="col-xs-12 topcart-bg" style="margin-top:0;">
      ...
      <span class="" style="margin-left:70px;">电话号码</span> 
      <span class="" style="margin-left:85px;">房号</span>
      <span class="" style="margin-left:140px;">问题描述</span>
      <span class="" style="margin-left:170px;">时间</span> 
        ...
        <ul>
            <li class="col-xs-12 property-repairslist">
              <div class="borderbt-ccc">
                ...
                <p class="" style="width:130px;">01234567890</p>
                <p class="" style=" width:120px;">1号楼2203室</p>
                <p class="" style="width:250px; margin-top:28px; text-align:left; padding:0 10px;">社区商城/熟食面点社区商城/熟食面点社区商城/熟社区商城/熟食面点</p>
                <p class="" style="width:160px;">2015-07-15 11:11:11</p>
                <div class="colsblueword" style="width:100px; float:left;">
