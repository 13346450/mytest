...
<div class="container" style="min-height:743px;">
  <div class="row"> 
   ...
   <div class="col-xs-10 border-ccc" style="margin:15px 0 0 15px; padding:0;">
      ...
      <div class="clear"></div>
      <p class="" style="margin:30px 90px;">旧密码：<input type="text" maxlength="100" class="border-ccc p08input"/></p>
      <p class="" style="margin:20px 90px;">新密码：<input type="text" maxlength="100" class="border-ccc p08input"/></p>
      <p class="" style="margin:20px 43px;">再次输入新密码：<input type="text" maxlength="100" class="border-ccc p08input"/></p>
       
          <input type="button" class="loginbtn left" style="width:120px; height:35px; line-height:30px; margin:20px 0 20px 155px;;" value="保存"/>
