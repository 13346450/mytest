...
<div class="container" style="margin-top:-30px; min-height:743px;">
  <div class="row">
    ...
    <div class="col-xs-9" style="padding-left:57px;">
      ...
      <div class="progress-pic progress-pic4" id="cart0304-pic"></div>
      <div class="progress-pic progress-pic5"></div>
    </div>
    </div>
    <div class="row">
    <div class="col-xs-2 topcart-font" id="cart03">订单提交</div>
    <div class="col-xs-10" style="padding-left:155px;">
      ...
      <div class="topcart-word"><span id="cart0304-blue1" style="color:#00a0e9; margin:5px;">订单提交成功</span><br/>
       <p class="color-gray" >2015-06-12 17:15:00</p>
      </div>
      <div class="topcart-word"><span id="cart0304-blue2" style="color:#000; margin:5px;">确认收货</span><br/>
        <p class="color-gray" id="cart0304-gray" style="display:none;">2015-06-12 17:15:00</p> 
      </div>
    ...
    <div class="row">
     <div class="col-xs-12 left-word03">i尚社区订单号：35664778922333<span class="margin100">状态：<span id="cart0304-state" style="color:#eb7f0c;"><b>已支付</b></span></span>
     <button class="right cart-nextbtn" id="cart-nextbtn1" type="button" onclick="myFunction()">确认收货</button>
     </div>
