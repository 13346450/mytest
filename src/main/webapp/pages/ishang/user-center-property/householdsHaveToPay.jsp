  ...
  <div class="row"> 
   ...
   <div class="col-xs-10" style="margin:15px 0 0 15px; padding:0;">
     <div class="col-xs-12 topcart-bg" style="margin-top:0;">
      <span>昵称</span>
      <span class="" style="margin-left:90px;">电话号码</span>
      <span class="" style="margin-left:110px;">房号</span> 
      <span class="" style="margin-left:100px;">缴费类别</span>
      <span class="" style="margin-left:95px;">缴费金额</span>
      <span class="" style="margin-left:120px;">时间</span>
      <span class="" style="margin-left:120px;">缴费状态</span> 
     </div>
       <ul class="reimburseitems">
              <li class="borderbt-ccc" style="text-align:center;">
                <p style="width:60px;">王小姐</p>
                <p class="" style="width:205px;">12345678912</p>
                <p class="" style="width:95px;">5号楼1203室</p>
                <p class="" style="width:190px;">物业费</p>
                <p class=" " style="width:115px;"><span class="red-word12">&yen;1289.00</span> </p>
                <p class=" " style="width:220px;">2015-07-15 11:25:20</p>
                <p class=" " style="width:90px; color:#289b49;">已缴费</p>
                <div class="clear"></div>
              </li>
              <li class="borderbt-ccc" style="text-align:center;">
               <p style="width:60px;">王小姐</p>
                <p class="" style="width:205px;">12345678912</p>
                <p class="" style="width:95px;">5号楼1203室</p>
                <p class="" style="width:190px;">停车费</p>
                <p class=" " style="width:115px;"><span class="red-word12">&yen;1289.00</span> </p>
                <p class=" " style="width:220px;">2015-07-15 11:25:20</p>
                <p class=" " style="width:90px; color:#289b49;">已缴费</p>
                <div class="clear"></div>
              ...
              <li class="borderbt-ccc" style="text-align:center;">
                ...
                <p class=" " style="width:115px;"><span class="red-word12">&yen;1289.00</span> </p>
                <p class=" " style="width:220px;">2015-07-15 11:25:20</p>
                <p class=" " style="width:90px; color:#ef3d4a;">未缴费</p>
                <div class="clear"></div>
              </li>
            </ul>
