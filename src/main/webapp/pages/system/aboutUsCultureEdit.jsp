...
<script type="text/javascript">
	...
	function save() {
		if ($("#form").form('validate')) {
			var json = {
				url : "${base}/system/SysAboutUSCulture/createOrUpdate",
				formId : "form",
	...
	$().ready(function(e){
		$.ajax({
			url:'${base}/system/SysAboutUSCulture/getInfo',
			dataType:'json',
			success:function(data){
				$("[name='cultureTitle']").val(data.cultureTitle);
				$("[name='cultureSubtitle']").val(data.cultureSubtitle);
				$("[name='cultureContent']").val(data.cultureContent);
			}
		})
	});
</script>
...
<body>
	...
	<form id="form">
		<table>
			<tr>
				<td>标题:</td>
				<td><input id="1" name="cultureTitle" type="text"
					class="easyui-validatebox" data-options="required:true" /></td>
			</tr>
			<tr>
				<td>副标题:</td>
				<td><input id="2" name="cultureSubtitle" type="text"
					class="easyui-validatebox" data-options="required:true" /></td>
			</tr>
			<tr>
				<td>正文:</td>
				<td><input id="3" name="cultureContent" type="text"
