...
<script type="text/javascript">
	...
	$(function(){
		...
		//单击事件
		tree.setOnClickHandler(function(id,state){parent.mainFrame.document.location="${base}/system/SysDept/edit/" + id;});
		...
		tree.setXMLAutoLoading("${base}/system/SysDept/creatSysDeptTree");
		tree.setDataMode("json");
		tree.loadJSON("${base}/system/SysDept/creatSysDeptTree?id=" + (-1));
	});
