...
<script type="text/javascript">
	...
	$(function(){
		...
		tree.setImagePath("${base}/resources/javascripts/dhtmlxtree/codebase/imgs/");
		...
		tree.setOnClickHandler(function(id,state){
			if(id!=="01")
				{parent.mainFrame.document.location="${base}/system/SysDict/edit/" + id;}
			}
		);
		...
		tree.setXMLAutoLoading("${base}/system/SysDict/creatSysDictTree");
		tree.setDataMode("json");
		tree.loadJSON("${base}/system/SysDict/creatSysDictTree?id=" + (-1));
	});
...
/* 		var state = tree.getOpenState(targetId);
		...
		$.ajax({
			url : "${base}/system/SysDept/saveDragAndDrop",
			async : false,
